...
{
  /// <summary>
  /// Represents the Internal System of Units (SI) Zeptometre
  /// </summary>
  public sealed class Zeptometre
  : UnitOfLength<Zeptometre>
  {
    /// <summary>
    /// Initializes a new instance of <see cref="Zeptometre"/>
    /// </summary>
    public Zeptometre()
      : base()
    { }
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="Zeptometre"/> with the
    /// specified value
    /// </summary>
    /// <param name="value">
    /// The value
    /// </param>
    public Zeptometre(decimal value)
      : base(value)
    {
    }
    ...
    /// </param>
    public Zeptometre(decimal value, ValueType type)
      : base(value, type)
    {
    }
