...
{
  /// <summary>
  /// Represents the Internal System of Units (SI) Nanometre
  /// </summary>
  public sealed class Nanometre
  : UnitOfLength<Nanometre>
  {
    /// <summary>
    /// Initializes a new instance of <see cref="Nanometre"/>
    /// </summary>
    public Nanometre()
      : base()
    { }
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="Nanometre"/> with the
    /// specified value
    /// </summary>
    /// <param name="value">
    /// The value
    /// </param>
    public Nanometre(decimal value)
      : base(value)
    {
    }
    ...
    /// </param>
    public Nanometre(decimal value, ValueType type)
      : base(value, type)
    {
    }
    ...
    {
      var result = nativeValue / 1000000;
