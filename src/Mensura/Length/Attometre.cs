...
{
  /// <summary>
  /// Represents the Internal System of Units (SI) Attometre
  /// </summary>
  public sealed class Attometre
  : UnitOfLength<Attometre>
  {
    /// <summary>
    /// Initializes a new instance of <see cref="Attometre"/>
    /// </summary>
    public Attometre()
      : base()
    { }
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="Attometre"/> with the
    /// specified value
    /// </summary>
    /// <param name="value">
    /// The value
    /// </param>
    public Attometre(decimal value)
      : base(value)
    {
    }
    ...
    /// </param>
    public Attometre(decimal value, ValueType type)
      : base(value, type)
    {
    }
